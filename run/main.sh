...
#python main.py --datapath Quadratic_Programming_Datasets --use_wandb False --ipm_alpha 0.73 --ipm_steps 8 --weight_decay 5.6e-6 --batchsize 512 --hidden 180 --num_pred_layers 3 --num_mlp_layers 2 --conv_sequence cov --loss_weight_x 1. --loss_weight_obj 2.4 --loss_weight_cons 7.5 --runs 1 --conv ginconv
